...
#    materialize_with_ddl.materialize_with_enum_test(clickhouse_node, started_mysql_5_7, "mysql57")
#    materialize_with_ddl.materialize_with_enum_test(clickhouse_node, started_mysql_8_0, "mysql80")
